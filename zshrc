...
plugins=(git autojump ruby osx zsh-syntax-highlighting rails antigen)
...
#   export EDITOR='mvim'
# fi
alias macdown="/opt/homebrew-cask/Caskroom/macdown/latest/MacDown.app/Contents/MacOS/MacDown"
alias -s md="mcdn"
# Compilation flags
# export ARCHFLAGS="-arch x86_64"
# ssh
# export SSH_KEY_PATH="~/.ssh/dsa_id"
alias atom="/Users/hjg/Applications/Atom.app/Contents/MacOS/Atom"
alias nano="atom"
export EDITOR="atom"
